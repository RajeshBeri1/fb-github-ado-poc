...
namespace Lib.WebAPI.ThirdParty
{
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Count not get table name for entity type {0}.
        /// </summary>
        internal static string CouldNotGetTableNameForEntityType {
            get {
                return ResourceManager.GetString("CouldNotGetTableNameForEntityType", resourceCulture);
            }
        }
