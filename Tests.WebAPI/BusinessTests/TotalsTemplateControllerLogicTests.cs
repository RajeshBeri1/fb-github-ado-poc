...
{
    /// <summary>
    /// TotalsTemplateControllerLogicTests
    /// </summary>
    public class TotalsTemplateControllerLogicTests : TestBase<ITotalsTemplateControllerLogic>
    {
        ...
        public TotalsTemplateControllerLogicTests()
        {
        ...
        public async Task CreateAsync_ShouldReturnTemplate_WhenTemplateIsCreated()
        {
            ...
            var template = new TotalsTemplateCreateDTO
            {
                Definition = new TotalsDefinition(),
        ...
        public async Task DeleteAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            var template = new TotalsTemplate
            {
                TotalsDefinition = "{}",
            ...
            portalDbContext.Set<TotalsTemplate>().Add(template);
        ...
        public async Task GetAsync_ShouldReturnTemplate_WhenTemplateExists()
        {
            ...
            var templateDto = mapper.Map<TotalsTemplateDetailsDTO>(template);
        ...
        public async Task GetAsync_ShouldReturnTemplates_WhenSearching()
        {
            ...
            var templates = new List<TotalsTemplateInfoDTO>();
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                templates.Add(mapper.Map<TotalsTemplateInfoDTO>(template));
            }

            await portalDbContext.SaveChangesAsync(CancellationToken);

            var search = new TotalsTemplateSearchDTO
            {
                Count = 10,
        ...
        public async Task UpdateAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            var update = new TotalsTemplateUpdateDTO
            {
                Definition = new(),
                Id = template.Id,
                Name = Guid.NewGuid().ToString(),
        ...
        protected override void InitContainer(ServiceRegistry registry)
        {
            ...
            var log = Substitute.For<ILog<TotalsTemplateControllerLogic>>();
            registry.For<ILog<TotalsTemplateControllerLogic>>().Use(log).Singleton();
