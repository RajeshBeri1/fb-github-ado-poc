...
{
    /// <summary>
    /// ThemeTemplateControllerLogicTests
    /// </summary>
    public class ThemeTemplateControllerLogicTests : TestBase<IThemeTemplateControllerLogic>
    {
        ...
        public ThemeTemplateControllerLogicTests()
        {
        ...
        public async Task CreateAsync_ShouldReturnTemplate_WhenTemplateIsCreated()
        {
            ...
            var template = new ThemeTemplateCreateDTO
            {
        ...
        public async Task DeleteAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            portalDbContext.Set<ThemeTemplate>().Add(template);
        ...
        public async Task GetAsync_ShouldReturnTemplate_WhenTemplateExists()
        {
            ...
            var templateDto = mapper.Map<ThemeTemplateDetailsDTO>(template);
        ...
        public async Task GetAsync_ShouldReturnTemplates_WhenSearching()
        {
            ...
            var templates = new List<ThemeTemplateInfoDTO>();
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                templates.Add(mapper.Map<ThemeTemplateInfoDTO>(template));
            }

            await portalDbContext.SaveChangesAsync(CancellationToken);

            var search = new ThemeTemplateSearchDTO
            {
                Count = 10,
        ...
        public async Task UpdateAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            var update = new ThemeTemplateUpdateDTO
            {
                Definition = new(),
                Id = template.Id,
                Name = Guid.NewGuid().ToString(),
        ...
        protected override void InitContainer(ServiceRegistry registry)
        {
            ...
            var log = Substitute.For<ILog<ThemeTemplateControllerLogic>>();
            registry.For<ILog<ThemeTemplateControllerLogic>>().Use(log).Singleton();
