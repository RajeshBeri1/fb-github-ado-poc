...
{
    /// <summary>
    /// FooterTemplateControllerLogicTests
    /// </summary>
    public class FooterTemplateControllerLogicTests : TestBase<IFooterTemplateControllerLogic>
    {
        ...
        public FooterTemplateControllerLogicTests()
        {
        ...
        public async Task CreateAsync_ShouldReturnTemplate_WhenTemplateIsCreated()
        {
            ...
            var template = new FooterTemplateCreateDTO
            {
                Definition = new FooterDefinition(),
        ...
        public async Task DeleteAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            var template = new FooterTemplate
            {
                FooterDefinition = "{}",
            ...
            portalDbContext.Set<FooterTemplate>().Add(template);
        ...
        public async Task GetAsync_ShouldReturnTemplate_WhenTemplateExists()
        {
            ...
            var templateDto = mapper.Map<FooterTemplateDetailsDTO>(template);
        ...
        public async Task GetAsync_ShouldReturnTemplates_WhenSearching()
        {
            ...
            var templates = new List<FooterTemplateInfoDTO>();
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                templates.Add(mapper.Map<FooterTemplateInfoDTO>(template));
            }

            await portalDbContext.SaveChangesAsync(CancellationToken);

            var search = new FooterTemplateSearchDTO
            {
                Count = 10,
        ...
        public async Task UpdateAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            var update = new FooterTemplateUpdateDTO
            {
                Definition = new(),
                Id = template.Id,
                Name = Guid.NewGuid().ToString(),
        ...
        protected override void InitContainer(ServiceRegistry registry)
        {
            ...
            var log = Substitute.For<ILog<FooterTemplateControllerLogic>>();
            registry.For<ILog<FooterTemplateControllerLogic>>().Use(log).Singleton();
