...
{
    /// <summary>
    /// CalendarTemplateControllerLogicTests
    /// </summary>
    public class CalendarTemplateControllerLogicTests : TestBase<ICalendarTemplateControllerLogic>
    {
        ...
        public async Task CreateAsync_ShouldReturnTemplate_WhenTemplateIsCreated()
        {
            ...
            var template = new CalendarTemplateCreateDTO
            {
        ...
        public async Task DeleteAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            portalDbContext.Set<CalendarTemplate>().Add(template);
        ...
        public async Task GetAsync_ShouldReturnTemplate_WhenTemplateExists()
        {
            ...
            var templateDto = mapper.Map<CalendarTemplateDetailsDTO>(template);
        ...
        public async Task GetAsync_ShouldReturnTemplates_WhenSearching()
        {
            ...
            var templates = new List<CalendarTemplateInfoDTO>();
            ...
            for (int i = 0; i < 100; i++)
            {
                ...
                templates.Add(mapper.Map<CalendarTemplateInfoDTO>(template));
            }

            await portalDbContext.SaveChangesAsync(CancellationToken);

            var search = new CalendarTemplateSearchDTO
            {
                Count = 10,
        ...
        public async Task UpdateAsync_ShouldReturnTemplate_WhenOwnerIsSame()
        {
            ...
            var update = new CalendarTemplateUpdateDTO
            {
                Definition = new(),
                Id = template.Id,
                Name = Guid.NewGuid().ToString(),
