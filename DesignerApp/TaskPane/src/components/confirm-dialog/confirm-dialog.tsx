                ...
                <div className="modal-content">
                    <article className={'message ' + props.type}>
                        <div className="message-header">
                            <Icon icon-id={'omni:' + props.icon}></Icon>
                            {props.title}
                        </div>
                        ...
                        <div className="message-footer">
                            <div className="field is-grouped is-grouped-right">
                                <div className="control">
                                    <button className="button is-text is-info" onClick={(e) => props.ok(e)}>
                                        {!!props.okBtn ? props.okBtn : 'Yes'}
                                    </button>
                                </div>
                                <div className="control">
                                    <button className="button is-text is-info" onClick={(e) => props.cancel(e)}>
